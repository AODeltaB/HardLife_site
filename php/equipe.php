...
?>
   ...
   <div id="index-banner" class="parallax-container">
    <div class="section no-pad-bot">
      <div class="container">
        <br><br>
        <h1 class="header center teal-text text-lighten-2">Notre équipe ?</h1>
        ...
        <div class="card-panel grey lighten-5 z-depth-1">
          <div class="row valign-wrapper">
            ...
            <div class="col s10">
			  ...
			  <h3>AO_DeltaB</h3>
                Je m'appelle Pierre, et je suis un des fondateurs du serveur, je m'occupe principalement du codage, et du site.
              </span>
            </div>
          </div>
        </div>
