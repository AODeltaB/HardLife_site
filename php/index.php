...
<body>
  ...
  if (isset($_SESSION['pseudo'])) {
    ...
    <nav class="white" role="navigation">
      <div class="nav-wrapper container">
        <a id="logo-container" href="index.php" class="brand-logo">Master 2, Droit du Numérique - Caen</a>
        <ul class="right hide-on-med-and-down">
          <li><a href="index.php">Accueil</a></li>
          <li><a href="/promote.php">Promotions</a></li>
  ...
  <div id="index-banner" class="parallax-container">
    <div class="section no-pad-bot">
      <div class="container">
        <br><br>
        <h1 class="header center teal-text text-lighten-2">Master 2, Droit du Numérique - Caen</h1>
    ...
    <div class="container">
      <div class="row">
        <div class="col l6 s12">
          <h5 class="white-text">Master 2, Droit du Numérique - Caen</h5>
